...
// min(w/3.6, h/2.35) at the 1440×900 reference viewport, lines are 1.3px,
...
function draw(withBg) {
	...
	// Unit box — page metrics: 1.3px stroke, alpha 0.4
	...
	// Polyline — page metrics: 1.3px stroke, alpha 0.55
